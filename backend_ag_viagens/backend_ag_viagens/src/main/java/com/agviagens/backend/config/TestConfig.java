...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Pedido o1 = new Pedido(null, Instant.parse("2022-02-10T19:53:07Z"), u1);
		Pedido o2 = new Pedido(null, Instant.parse("2022-02-11T03:42:10Z"), u2);
		Pedido o3 = new Pedido(null, Instant.parse("2019-02-12T15:21:22Z"), u1);
